...
class _DemoMWDrawerScreen2State extends State<DemoMWDrawerScreen2> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  itemList(Icon(Icons.notifications, color: appStore.iconColor),
                      "Notifications",(){}),
                  Divider(),
                  SizedBox(
                    height: 15,
                  ...
                  itemList(Icon(Icons.info_outline, color: appStore.iconColor),
                      "Help",(){}),
                  Divider(),
                  SizedBox(
                    height: 15,
  ...
  Widget itemList(Widget icon, String title, Function ontap) {
